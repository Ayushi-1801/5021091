public class Main {
    public static void main(String[] args) {
        ...
        Employee emp1 = new Employee(1, "Ayushi", "Software Developer", 100000);
        Employee emp2 = new Employee(2, "Anwesha", "Hiring Manager", 100000);
        Employee emp3 = new Employee(3, "Anshita", "Data Analyst", 500000);
        ...
        Employee emp4 = new Employee(4, "Aayush", "Designer", 550000);
